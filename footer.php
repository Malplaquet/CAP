        ...
        <div class="contacts-permanence">
          ...
          <div class="row row-contact-footer">
            <div class="col-2 container_logo_footer">
              <img class="logo_footer" src="/CAP/wp-content/themes/blogCathy/img/house.svg" alt="">
            </div>
          ...
          <div class="row row-contact-footer">
            <div class="col-2 container_logo_footer">
              <img class="logo_footer" src="/CAP/wp-content/themes/blogCathy/img/phone2.svg" alt="">
            </div>
            <div class="col-10 align-items-center">
          ...
          <div class="row row-contact-footer">
            <div class="col-2 container_logo_footer">
              <img class="logo_footer" src="/CAP/wp-content/themes/blogCathy/img/bank.svg" alt="">
            </div>
            <div class="col-10">
