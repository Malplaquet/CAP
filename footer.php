    ...
    <div class="row justify-content-around">
      ...
      <div class="col-3">
        ...
        <div class="contacts-permanence">
          <h2>Permanence parlementaire :</h2>
          <div class="row row-contact-footer">
            <div class="col-2">
              <img src="/CAP/wp-content/themes/blogCathy/img/house.svg" alt="">
            </div>
            <div class="col-10 align-items-center">
              <span>66, rue de la gare<br/>62300, Lens</span>
            </div>
          </div>
          <div class="row row-contact-footer">
            <div class="col-2">
              <img src="/CAP/wp-content/themes/blogCathy/img/phone2.svg" alt="">
            </div>
            <div class="col-10 align-items-center">
              <span>03&middot;21&middot;08&middot;12&middot;12</span>
            </div>
          </div>
        </div>
      </div>
