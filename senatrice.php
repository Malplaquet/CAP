...
<div id="content">
  <div class="container">
    <div class="row justify-content-center">
      <h2 class="title_page_senatrice">Découvrir la sénatrice</h2>
    </div>
    <div class="row bio_container_senatrice justify-content-center">
      <div class="col-10 col-xl-5">
        <div class="avatar_container_senatrice">
          <img class="avatar_senatrice" src="/CAP/wp-content/themes/blogCathy/img/avatar-cathy.jpg" alt="">
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="text_senatrice">
          ...
          <div class="row">
            <div class="col-xl-7 col-12 text_senatrice side_text_senatrice">
          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-12 side_text_senatrice">
